...
function HeaderEditMenu({ clickHandler, mouseLeaveHandler, id, isMenuVisible = false, removeHandler, copyHandler }) {
    return (
        <div onClick={clickHandler} onMouseLeave={mouseLeaveHandler} className='relative w-fit cursor-pointer'>
            ...
            <div className={`${isMenuVisible ? "inline-block" : "hidden"} absolute z-10 w-40 left-0 bg-secondary-dark border rounded  border-gray-200`}>
                <div id={id} onClick={removeHandler} className='flex justify-center items-center w-full cursor-pointer hover:bg-gray-600 border-b gap-4'>
                    <p id={id}>حذف</p>
                ...
                <div id={id} onClick={copyHandler} className='flex justify-center items-center w-full cursor-pointer hover:bg-gray-600 gap-4'>
                    <p id={id}>کپی</p>
                    <svg id={id} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
